...
public class RssFeedUnitTest {
  ...
  /**
   * Calls the RSS feed endpoint and checks that the result matches an expected one.
   * 
   * @throws Exception
   */
  @Test
