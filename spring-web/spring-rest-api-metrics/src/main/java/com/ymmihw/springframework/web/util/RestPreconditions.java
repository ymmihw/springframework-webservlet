package com.ymmihw.springframework.web.util;

import org.springframework.http.HttpStatus;
import com.ymmihw.springframework.web.exception.MyResourceNotFoundException;

/**
 * Simple static methods to be called at the start of your own methods to verify correct arguments
 * and state. If the Precondition fails, an {@link HttpStatus} code is thrown
 */
