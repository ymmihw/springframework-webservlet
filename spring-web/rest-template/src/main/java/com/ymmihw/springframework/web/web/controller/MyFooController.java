...
import com.ymmihw.springframework.web.web.exception.ResourceNotFoundException;
...
public class MyFooController {
  ...
  public Foo createFoo(@RequestBody final Foo foo, HttpServletResponse response) {
    ...
    response.setHeader("Location",
        ServletUriComponentsBuilder.fromCurrentRequest().path("/" + foo.getId()).toUriString());
    return foo;
  }
