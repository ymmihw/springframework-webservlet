...
public class RestTemplateBasicLiveTest {
  ...
  public void givenResourceUrl_whenSendGetForRequestEntity_thenBodyCorrect() throws IOException {
    ...
    final ResponseEntity<String> response =
        template.getForEntity(fooResourceUrl + "/1", String.class);
  ...
  public void givenFooService_whenPutExistingEntity_thenItIsUpdated() {
    ...
    // Create Resource
    final ResponseEntity<Foo> createResponse =
    ...
    final ResponseEntity<Foo> updateResponse =
        restTemplate.exchange(resourceUrl, HttpMethod.GET, new HttpEntity<>(headers), Foo.class);
  ...
  public void givenFooService_whenPutExistingEntityWithCallback_thenItIsUpdated() {
    ...
    restTemplate.execute(resourceUrl, HttpMethod.PUT, requestCallback(updatedInstance),
  ...
  private RequestCallback requestCallback(final Foo updatedInstance) {
    return clientHttpRequest -> {
      ...
      clientHttpRequest.getHeaders().add(HttpHeaders.CONTENT_TYPE,
          MediaType.APPLICATION_JSON_VALUE);
      clientHttpRequest.getHeaders().add(HttpHeaders.AUTHORIZATION,
